  ...
  return (
    ...
    <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
      ...
      <div className="max-w-3xl mb-10 lg:mb-14">
        ...
        <p className="mt-1 text-neutral-400">Voici un resumé de mon parcours qui m'a permis de gagner des experiences et qui me rend unique et qualifié.</p>
      </div>
...
<div className="flex gap-x-3">
  ...
  <div className="min-w-14 text-end">
    <span className="text-xs text-blue-500 text-nowrap">2021-2022</span>
  </div>
  ...
  <div className="grow pt-0.5 pb-8">
    <h3 className="flex gap-x-1.5 font-semibold text-white">
      ...
      Bachelor Serie D - L1 Génie Logiciel
    </h3>
...
<div className="flex gap-x-3">
  ...
  <div className="min-w-14 text-end">
    <span className="text-xs text-blue-500 text-nowrap ">2022-2023</span>
  </div>
  ...
  <div className="grow pt-0.5 pb-8">
    <h3 className="flex gap-x-1.5 font-semibold text-white">
      L2 Génie Logiciel - Formation en Developpement Web - Stage de 02 mois
    </h3>
    <p className="mt-1 text-sm text-gray-200 ">
...
<div className="flex gap-x-3">
  ...
  <div className="min-w-14 text-end">
    <span className="text-xs text-blue-500 ">2024</span>
  </div>
  ...
  <div className="grow pt-0.5 pb-8">
    <h3 className="flex gap-x-1.5 font-semibold text-white ">
      L3 Génie Logiciel - Stage 03 mois
    </h3>
    <p className="mt-1 text-sm text-gray-200 ">
