  ...
  return (
    ...
    <div className="bg-neutral-900 bg-linear-to-t from-black to-transparent">
      <div className="max-w-5xl px-4 xl:px-0 py-24 mx-auto">
        ...
        <div className="max-w-[437px]   bg-transparent border-1 border-gray-700 mb-5 h-15  rounded-full flex-col ">
            <button className="bg-blue-500 text-neutral-300 h-full px-3 rounded-l-full">Application Web</button>
            <button className="bg-blue-500 text-neutral-300 h-full px-3 ">Site Web</button>
            <button className="bg-blue-500 text-neutral-300 h-full px-3 rounded-r-full">Outils De Developpement</button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center border border-neutral-700 divide-y lg:divide-y-0 lg:divide-x divide-neutral-700 rounded-xl">
          ...
          <a className="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 focus:outline-hidden first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-linear-to-b hover:before:from-transparent hover:before:via-transparent hover:before:to-blue-500/10 before:via-80% focus:before:from-transparent focus:before:via-transparent focus:before:to-blue-500/10 before:-z-1 last:before:rounded-b-xl lg:first:before:rounded-s-xl lg:last:before:rounded-e-xl lg:last:before:rounded-bl-none before:opacity-0 hover:before:opacity-100 focus:before:opacity-100" href="#">
            <div className="mb-5">
           ...
           <p className="font-semibold text-5xl text-white">43%</p>\
            ...
            <p className="mt-auto">
              <span  disabled:pointer-events-none aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-full-screen-modal" data-hs-overlay="#hs-full-screen-modal" className="font-medium text-sm text-blue-500 pb-1 border-b-2 border-neutral-700 group-hover:border-blue-500 group-focus:border-blue-500 transition focus:outline-hidden">
                Case study
              </span>
            </p>
          </a>
