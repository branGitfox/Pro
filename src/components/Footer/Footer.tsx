...
function Footer() {
  return (
    <>
        <hr className='absolute top-[4000px] w-[100%] md:top-[655.5%] xl:top-[2800px]  border-blue-600 border-2'/>
        <div className="absolute mt-1 flex flex-wrap justify-evenly top-[4000px] w-[100%] md:top-[655.5%] xl:top-[2800px] p-5   bg-gray-900">
        ...
        <footer id='footer' className='absolute top-[4800px] w-[100%] md:top-[763.5%] xl:top-[3200px]'>
