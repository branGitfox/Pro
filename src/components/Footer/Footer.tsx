...
function Footer() {
  return (
    <>
        <hr className='absolute top-[4000px] w-[100%] md:top-[723.5%] lg:top-[2600px] border-blue-600 border-2'/>
        <div className="absolute mt-1 flex flex-wrap justify-evenly top-[4000px] w-[100%] md:top-[723.5%] lg:top-[2600px] p-5   bg-gray-900">
        ...
        <footer id='footer' className='absolute top-[4800px] w-[100%] md:top-[923.5%] lg:top-[3000px]'>
