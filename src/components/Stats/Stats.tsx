  ...
  return (
    <>
            ...
            <div className="flex flex-col items-center justify-center border-r-2 border-blue-600">
                    <p className='font-bold text-2xl text-gray-300 '>{isLoading?( <ClipLoader size={20} color="blue" />):data?.public_repos+'+'}</p>
                    <p className='text-white font-light'>Repository</p>
            </div>
            <div className="flex flex-col  items-center justify-center border-r-2 border-blue-600">
                    <p className='font-bold text-2xl text-gray-300 '>{isLoading?( <ClipLoader size={20} color="blue" />):data?.followers+'+'}</p>
                    <p className='text-white font-light'>Followers</p>
            </div>
            <div className="flex flex-col  items-center justify-center ">
                    <p className='font-bold text-2xl text-gray-300 '>{isLoading?( <ClipLoader size={20} color="blue" />):data?.following+'+'}</p>
