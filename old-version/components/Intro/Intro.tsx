   ...
   <>
        <div className="w-[100%]  flex flex-col align-center p-5 relative top-[8rem] md:top-40">
            ...
            <div className="mt-[5rem] text-center md:w-[400px] m-auto flex flex-row gap-3 justify-between">
                ...
                <a target='_blank' href='https://github.com/BranGitfox' className='border border-blue-700 py-4 shadow-md shadow-blue-600 px-3  md:px-10 rounded font-bold text-white'>GitHub<GitHub className='inline mx-3'/></a> 
            </div>
        </div>
   </>
  )
